...
class SettingAdapter(data: List<SettingVM>?) : BaseQuickAdapter<SettingVM, BaseViewHolder>(R.layout.mpt_item_setting, data) {
...
//        helper.setImageDrawable(R.id.item_setting_iv, helper.itemView.context.resources.getDrawable(item.icon))
        helper.setBackgroundColor(R.id.item_setting_iv, mContext.resources.getColor(R.color.mpt_colorPrimary))
    }
}
