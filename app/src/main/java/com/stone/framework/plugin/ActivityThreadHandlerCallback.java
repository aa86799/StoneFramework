    ...
    public boolean handleMessage(Message msg) {
        ...
        if (msg.what == 100) {
            try {
                ...
                // 根据 getPackageInfo 这个 包名获取 LoadedApk的信息; 因此这里我们需要手动填上, 从而能够命中缓存
        ...
        LoadApkResDir.switchToPlugResources("/data/user/0/com.stone.framework/app_plugin/plugint.apk");
