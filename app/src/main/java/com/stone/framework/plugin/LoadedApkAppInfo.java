...
import com.stone.framework.plugin.util.RefInvoke;
...
public class LoadedApkAppInfo {
    private static String TAG = LoadedApkAppInfo.class.getName();
    ...
    public static void hookLoadedApkInActivityThread(File apkFile) throws Exception {
        ...
        /*
         *   sCurrentActivityThread 中的 mPackages ，保存了 <插件的 packageName, 插件的 applicationInfo>
         */
    }
